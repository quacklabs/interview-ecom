...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Pay User Profit</h2>
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <div class="card">
                        <form id="orderForm" action="{{ route('admin.pay_profit', ['id' => $id]) }}" method="POST">
                                ...
                                <div class="px-2">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input id="plan_name" name="amount" type="text" class="form-control" value="" required>
                                        </div>
                                    </div>                                    
                                </div> 
                            </div>
