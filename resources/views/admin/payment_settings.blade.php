...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Manage gateway and currencies</h2>
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <div class="card">
                        <form id="orderForm" action="{{ route('admin.payment_gateway') }}" method="POST">
                                ...
                                <div class="px-2">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">API GATEWAY KEY</label>
                                            <input id="featureList" name="features" type="hidden">
                                            <input id="public_key" name="public_key" type="text" class="form-control" value="{{ $widget->publicKey ?? '' }}" required>
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">PRIVATE KEY</label>
                                            <input id="featureList" name="features" type="hidden">
                                            <input id="min_amount" name="private_key" type="text" class="form-control" value="{{ $widget->safeKey ?? '' }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>Accepted Currencies (symbols only)</label>
