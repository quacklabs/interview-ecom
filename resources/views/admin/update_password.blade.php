    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <div class="card">
                        <form id="orderForm" action="{{ route('admin.change_password') }}" method="POST">
                                ...
                                <div class="px-2">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input id="public_key" name="old_password" type="text" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input id="featureList" name="features" type="hidden">
                                            <input id="min_amount" name="password" type="text" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input id="featureList" name="features" type="hidden">
                                            <input id="min_amount" name="password_confirmation" type="text" class="form-control" value="" required>
                                        </div>
                                    </div>
